...
import com.sojpt.model.Intellectualization;
 ...
 */
@RestController
@RequestMapping("/admin/intellectualization/")
@Before({AdminLoginInterceptor.class, AdminPopedomInterceptor.class})
public class IntellectualizationAdminController  extends IViewController {
   ...
   @RequestMapping("list")
    public void list() {
        ...
        Intellectualization intellectualization = getModel(Intellectualization.class, "intellectualization");

        SqlPara sqlPara = Db.getSqlPara("admin_intellectualization.select", getKv(intellectualization));
    ...
    public void delete() {
        Intellectualization intellectualization = getModel(Intellectualization.class, "intellectualization");
        if(Intellectualization.dao.deleteById(intellectualization.getId())) {
            renderJson(Ret.ok());
        } else {
            renderJson(Ret.fail());
        }
    ...
    public void batchDelete() {
        ...
        SqlPara sqlPara = Db.getSqlPara("admin_intellectualization.deleteByIds", Kv.by("idList", Arrays.asList(ids)));
