...
import com.sojpt.model.IntellectCase;
...
public class IntellectCaseAdminController  extends IViewController {
    ...
    public void list() {
        ...
        IntellectCase intellectCase = getModel(IntellectCase.class, "intellectCase");

        SqlPara sqlPara = Db.getSqlPara("admin_case.select", getKv(intellectCase));
    ...
    public void delete() {
        IntellectCase intellectCase = getModel(IntellectCase.class, "intellectCase");
        if(IntellectCase.dao.deleteById(intellectCase.getId())) {
            renderJson(Ret.ok());
        } else {
            renderJson(Ret.fail());
        }
    ...
    public void batchDelete() {
        ...
        SqlPara sqlPara = Db.getSqlPara("admin_case.deleteByIds", Kv.by("idList", Arrays.asList(ids)));
