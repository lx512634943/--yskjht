...
import com.sojpt.model.SupplyChain;
...
public class SupplyChainAdminController extends IViewController {
   ...
   @RequestMapping("list")
    public void list() {
        ...
        SupplyChain supplyChain = getModel(SupplyChain.class, "supplyChain");

        SqlPara sqlPara = Db.getSqlPara("admin_chain.select", getKv(supplyChain));
    ...
    public void delete() {
        SupplyChain supplyChain = getModel(SupplyChain.class, "supplyChain");
        if(SupplyChain.dao.deleteById(supplyChain.getId())) {
            renderJson(Ret.ok());
        } else {
            renderJson(Ret.fail());
        }
    ...
    public void batchDelete() {
        ...
        SqlPara sqlPara = Db.getSqlPara("admin_chain.deleteByIds", Kv.by("idList", Arrays.asList(ids)));
