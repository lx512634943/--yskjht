...
import com.sojpt.model.ProjectCases;
...
public class ProjectCasesAdminController extends IViewController {
    ...
    public void list() {
        ...
        SqlPara sqlPara = Db.getSqlPara("admin_cases.select", getKv(projectCases));
    ...
    public void batchDelete() {
        ...
        SqlPara sqlPara = Db.getSqlPara("admin_cases.deleteByIds", Kv.by("idList", Arrays.asList(ids)));
