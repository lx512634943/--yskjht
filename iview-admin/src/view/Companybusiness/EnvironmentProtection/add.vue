  ...
  >
    ...
    >
      <FormItem label="业务名称" :label-width="100" prop="business_id" >
        <Select v-model="formEnvironmentProtection.business_id" style="width:200px" >
...
<script>
  import { save } from '@/api/protection'
    ...
    methods: {
      ...
      handleSubmit (name) {
        this.$refs[name].validate(valid => {
          if (valid) {
            save(Object.assign({}, createModelObj(this.formEnvironmentProtection, 'environmentProtection'))).then(
              res => {
                if (res) {
