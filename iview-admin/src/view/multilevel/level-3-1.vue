  ...
  <div>
    <Card>
      ...
      <ButtonGroup style="margin-bottom: 15px;">
        ...
        <Add v-model="isOpenAddPage" @addRow="addSucceed"/>
        <Edit v-model="isOpenEditPage" @updateRow="updateSucceed" :succeed="editSucceed"/>
...
<script>
  import { list, del, batchDelete} from '@/api/succeed'
