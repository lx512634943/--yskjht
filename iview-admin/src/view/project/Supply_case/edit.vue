...
<script>
  import { update } from '@/api/chainfinance'
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit (name) {
        this.$refs[name].validate(valid => {
          if (valid) {
            update(
              Object.assign({}, createModelObj(this.formSupplyChainfinance, 'supplyChainfinance'))
            ).then(res => {
              if (res) {
                this.$emit('updateRow', coverProps(this.supplyChainfinance, this.formSupplyChainfinance))
    ...
    watch: {
      value: function (val, oldVal) {
        this.$refs.formSupplyChainfinance.resetFields()
